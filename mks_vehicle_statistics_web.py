...
def main():
    ...
    with col2:
        st.markdown(f"<h2 style='margin-bottom: 0px;'>Japan Vehicle Export Statistics</h2>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: {MKS_BLUE}; font-size: 0.9em;'>Multi-year Japan Customs export data | New and Used vehicles</p>", unsafe_allow_html=True)
